              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-2xl font-bold text-red-400 tracking-tight"><AnimatedCounter end={4500} prefix="$" /></div>
                  </div>
                ...
                <div className="border-t border-slate-800/50 pt-6">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold text-emerald-400 tracking-tight"><AnimatedCounter end={4203} prefix="$" /></div>
                      <div className="text-[10px] text-slate-500 font-mono uppercase tracking-wider">Monthly Savings</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-emerald-400 tracking-tight"><AnimatedCounter end={50436} prefix="$" /></div>
